...
exports.getStudentsController = void 0;
const httpStatusCode_1 = require("../../_lib/common/httpStatusCode");
const getStudentsController = (dependencies) => {
    ...
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const result = yield getStudentsUseCase(dependencies).execute(page, limit);
            if (!result) {
                res.status(httpStatusCode_1.httpStatusCode.NOT_FOUND).json({ success: false, message: "No students found" });
                return;
            }
