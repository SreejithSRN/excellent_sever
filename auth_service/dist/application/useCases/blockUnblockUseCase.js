...
exports.blockUnblockUseCase = void 0;
const blockUnblockUseCase = (dependencies) => {
    const { repositories } = dependencies;
    const { blockUnblock } = repositories;
    return {
        execute: (email) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                return yield blockUnblock(email);
            }
            catch (error) {
...
exports.blockUnblockUseCase = blockUnblockUseCase;
